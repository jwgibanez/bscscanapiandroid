...
class AccountServiceTest: BscScanApiImpl() {
    @Test
    fun accountServiceTest_getAddressBalance() {
        val testObserver = accountService.getBalance(
    ...
    fun accountServiceTest_getAddressBalanceMulti() {
        ...
        val testObserver = accountService.getBalanceMulti(
            address = address
            , apiKey = API_KEY
        ).test()
        testObserver.awaitTerminalEvent()
    ...
    fun accountServiceTest_getTransactions() {
        val testObserver = accountService.getTransactionsByAddress(
            address = "0x0000000000000000000000000000000000001004"
            , startBlock = "4100"
            , endBlock = "4104"
            , apiKey = API_KEY
    ...
    fun accountServiceTest_getInternalTransactions() {
        val testObserver = accountService.getInternalTransactionsByAddress(
            address = "0x0000000000000000000000000000000000001004"
            , startBlock = "0"
            , endBlock = "270257"
            , apiKey = API_KEY
    ...
    fun accountServiceTest_getInternalTransactionsByHash() {
        val testObserver = accountService.getInternalTransactionsByHash(
    ...
    fun accountServiceTest_getInternalTransactionsByBlockRange() {
        val testObserver = accountService.getInternalTransactionsByBlockRange(
            startBlock = "0"
            , endBlock = "270257"
            , page = "1"
            , offset = "10"
    ...
    fun accountServiceTest_getBep20TokenTransferEventsByAddress() {
        val testObserver = accountService.getBep20TokenTransferEventsByAddress(
    ...
    fun accountServiceTest_getBep20TokenTransferEventsByContractAddress() {
        val testObserver = accountService.getBep20TokenTransferEventsByContractAddress(
    ...
    fun accountServiceTest_getBep20TokenTransferEvents() {
        val testObserver = accountService.getBep20TokenTransferEvents(
            address = "0x7bb89460599dbf32ee3aa50798bbceae2a5f7f6a"
            , contractAddress = "0xc9849e6fdb743d08faee3e34dd2d1bc69ea11a51"
            , page = "1"
            , offset = "10"
    ...
    fun accountServiceTest_getErc721TokenTransferEventsByAddress() {
        val testObserver = accountService.getErc721TokenTransferEventsByAddress(
    ...
    fun accountServiceTest_getErc721TokenTransferEventsByContractAddress() {
        val testObserver = accountService.getErc721TokenTransferEventsByContractAddress(
    ...
    fun accountServiceTest_getErc721TokenTransferEvents() {
        val testObserver = accountService.getErc721TokenTransferEvents(
            address = "0xcd4ee0a77e09afa8d5a6518f7cf8539bef684e6c"
            , contractAddress = "0x5e74094cd416f55179dbd0e45b1a8ed030e396a1"
            , page = "1"
            , offset = "100"
    ...
    fun accountServiceTest_getBlocksValidatedByAddress() {
        val testObserver = accountService.getBlocksValidatedByAddress(
